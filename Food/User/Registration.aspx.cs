    ...
    public partial class Registration : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            if (isValidToExecute)
            {
                ...
                try
                {
                    ...
                    cmd.ExecuteNonQuery();
                    actionName = userId == 0 ?
                        "Đăng ký thành công! <b><a href='login.aspx'>Bấm Vào Đây</a></b> Để Đăng Nhập " :
                        "Cập nhật thành công! <b><a href='Profile.aspx'> Có thể bấm vào đây để kiểm tra</a></b>";
                    lblMsg.Visible = true;
                ...
                catch (SqlException ex)
                {
                    ...
                    {
                        lblMsg.Visible = true;
                        lblMsg.Text = "<b>" + txtUserName.Text.Trim() + "</b> Người dùng đã tồn tại hãy thử lại!";
                        lblMsg.CssClass = "alert alert-danger";
        ...
        private void getUserDetails()
        {
           ...
           if(dt.Rows.Count == 1)
            ...
            lblHeaderMsg.Text = "<h2> Edit Hồ Sơ </h2>";

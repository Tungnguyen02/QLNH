<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="Food.User.Payment" %>
            ...
            <div class="row pb-5">
                <div class="col-lg-6 mx-auto">
                    <div class="card ">
                        <div class="card-header">
                            <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                                ...
                                <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                    ...
                                    <li class="nav-item"><a data-toggle="pill" href="#paypal" class="nav-link "><i class="fa fa-money mr-2"></i>Thanh Toán VNP </a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="credit-card" class="tab-pane fade show active pt-3">
                                    <div role="form">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="Tên chủ sở hữu thẻ"></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <label for="txtCardNo">
                                                <h6>Số Thẻ</h6>
                                ...
                                <div id="paypal" class="tab-pane fade pt-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtCODAddress" runat="server" CssClass="form-control" placeholder="Nhập địa chỉ"
                                    ...
                                    <p class="text-muted">
                                      Lưu ý: Vui lòng nhập địa chỉ giao hàng chính xác
                                      Sau khi hoàn tất quá trình thanh toán, bạn có thể kiểm tra trạng thái đơn hàng được cập nhật của mình.
                                      Xin cảm ơn!
                                    </p>
                                </div>
                                <!-- End -->
                        ...
                        <div class="card-footer">
                            <b class="badge badge-success badge-pill shadow-sm">Tổng Tiền Thanh Toán: <% Response.Write(Session["grandTotalPrice"]); %> ₫</b>
                            <div class="pt-1">

                ...
                <ItemTemplate>
                    <tr>
                        <td>
                          ...
                          <td>
                            <img width="60" src="<%# Food.Utils.GetImageUrl(Eval("ImageUrl")) %>" alt="" />
                        </td>

                        <td><asp:Label ID="lblPrice" runat="server" Text='<%#Eval("Price") %>'></asp:Label> VND
                    ...
                    <tr>
                        <td colspan="2" class="continue__btn">
                            <a href="Menu.aspx" class="btn btn-info" > 
                                <i class="fa fa-arrow-circle-left mr-2"></i> Tiếp Tục Chọn Món</a>
                        </td>                   
                        <td>

                                ...
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            <h4 class="sub-title">Món Ăn</h4>
                                            <div>
                                                <div class="form-group">
                                                    <label> Tên Món</label>
                                                    <div>
                                                          <asp:TextBox ID="txtName" runat="server" CssClass="form-control"
                                                              planceholder="Enter Product  Name"></asp:TextBox>
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div>
                                                          <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control"
                                                              planceholder="Enter Product  Description" TextMode="MultiLine"></asp:TextBox>
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div>
                                                          <asp:TextBox ID="txtPrice" runat="server" CssClass="form-control"
                                                              planceholder="Enter Product  Price"></asp:TextBox>
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div>
                                                          <asp:TextBox ID="txtQunatity" runat="server" CssClass="form-control"
                                                              planceholder="Enter Product  Qunatity"></asp:TextBox>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                            ErrorMessage="Qunatity must be non negative" SetFocusOnError="true"   Display="Dynamic"
                                                            
                                                            ValidationExpression="^([1-9]\d*|0)$" ControlToValidate="txtQunatity" ForeColor="Red" >
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div>                                        
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cs %>" SelectCommand="SELECT [CategoryId], [Name] FROM [Categories]">
                                                                ...
                                                                <%-- phan 5 sai--%>
                                                                 ...
                                                                 <td>
                                                                     ...
                                                                     <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CommandName="delete"
                                                                         ...
                                                                         OnClientClick="return confirm('Bạn có muốn xóa món này?');"
